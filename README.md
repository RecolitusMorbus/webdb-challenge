...
1. Explain the difference between `RDBMS` and `SQL`.
    ...
    A `RDBMS` is a rational database that is built to the specifications of `SQL`, which is a standard rather than a
    actual program.

2. Why do tables need a `primary key`?

    To differentiate between the myriad tables among a database.
...
4. What do we need in order to have a _many to many_ relationship between two tables.
    ...
    The `Many to Many` is a construct of the mind and doesn't exist. According to Luis.
